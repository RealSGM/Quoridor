...
\noindent I created a MoSCoW table to prioritise sections of the project. Since this project is local game, the main focus will be on the main mechanics of the game, such as the fence placement and pawn movement and AI. Once the main mechanics have been implemented, I can then focus on additional features such as comparing different type of AI algorithms.
